...
public:
    ...
    void ApplyToScene(CoreEngine::BaseScene* scene, Args&&... args) {
    ...
    int Spawn(const CoreEngine::Vector3& pos, const CoreEngine::Vector3& rotate, const CoreEngine::Vector3& scale);
